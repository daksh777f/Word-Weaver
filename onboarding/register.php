...
<head>
    ...
    <title>Register - CodeDungeon</title>
...
<body>
    ...
    <div class="auth-container">
        ...
        <div class="auth-header">
            <span class="codedungeon-logo auth-logo"><span class="logo-icon">⚔️</span><span class="logo-text">Code<span class="logo-accent">Dungeon</span></span></span>
        ...
        <form class="auth-form" method="POST" action="">
            ...
            <div class="form-group">
                ...
                <select 
                    ...
                    <option value="Learner" <?php echo ($_POST['grade_level'] ?? '') === 'Learner' ? 'selected' : ''; ?>>Learner</option>
                    <option value="Creator" <?php echo ($_POST['grade_level'] ?? '') === 'Creator' ? 'selected' : ''; ?>>Creator</option>
                    <option value="Teacher" <?php echo ($_POST['grade_level'] ?? '') === 'Teacher' ? 'selected' : ''; ?>>Teacher (legacy)</option>
                </select>
            </div>

            <div class="form-group" id="teacher_unlock_group" style="display: <?php echo in_array(($_POST['grade_level'] ?? ''), ['Teacher', 'Creator'], true) ? 'block' : 'none'; ?>;">
                <label for="teacher_unlock_password">
                    <i class="fas fa-key"></i>
                    Creator Access Password
                </label>
                <input 
                    type="password" 
            ...
            <div class="agreement-group">
                ...
                <label for="agree_terms">
                    ...
                    <a href="../docs/student-guide.php" target="_blank">Learner Guide</a>
                </label>
            </div>
    ...
    <script>
        ...
        // Toggle creator access password field
        ...
        gradeLevelSelect.addEventListener('change', function() {
            if (this.value === 'Teacher' || this.value === 'Creator') {
