    ...
    <main class="page-content">
        ...
        <section class="glass-panel">
            ...
            <div class="developer-card">
                <div style="position: relative; z-index: 2; max-width: 70%;">
                    <h3 style="color: var(--primary); margin-bottom: 10px; font-size: 1.1rem;">Contact Developers</h3>
                    <div style="margin-bottom: 12px;">
                        <p style="margin-bottom: 4px; font-weight: bold;">Daksh Goel</p>
        ...
        <section class="glass-panel">
            ...
            <p style="color: var(--text-muted); margin-bottom: 20px;">
                Proudly developed by <strong>Daksh Goel</strong> and <strong>Chirag Aggarwal</strong>.
            </p>
            
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 16px;">
                <div class="team-member-card">
                    <img src="../assets/menu/defaultuser.png" alt="Daksh Goel" style="width: 90px; height: auto; object-fit: contain;">
                    <div>
                        <div style="font-weight: 600; color: var(--text); margin-bottom: 2px;">Daksh Goel</div>
                        <div style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 6px;">Core Developer</div>
                    </div>
                </div>

                <div class="team-member-card">
                    <img src="../assets/menu/defaultuser.png" alt="Chirag Aggarwal" style="width: 90px; height: auto; object-fit: contain;">
                    <div>
                        <div style="font-weight: 600; color: var(--text); margin-bottom: 2px;">Chirag Aggarwal</div>
                        <div style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 6px;">Core Developer</div>
                    </div>
                </div>
            </div>
