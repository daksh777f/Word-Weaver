...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .glass-panel h3 { font-size: 1.1rem; font-weight: 600; margin-bottom: 10px; color: var(--text); margin-top: 20px; }
...
<body>
    ...
    <main class="page-content">
        ...
        <section class="glass-panel">
            ...
            <ul>
                <li>Username, email address, and grade level during registration</li>
                <li>Encrypted password (using bcrypt hashing)</li>
            </ul>
            <h3>Usage Data</h3>
            <ul>
                <li>Game progress, scores, and performance analytics</li>
                <li>Login timestamps and session data</li>
                <li>Character selections and in-game currency balances</li>
            </ul>
        </section>
        ...
        <section class="glass-panel">
            ...
            <ul>
                ...
                <li>To track your learning progress and game performance</li>
                <li>To display leaderboard rankings and Mastery Score calculations</li>
                <li>To enable social features such as friends and profile views</li>
                <li>To allow creators to monitor learner progress</li>
            </ul>
        </section>
        ...
        <section class="glass-panel">
            ...
            <ul>
                ...
                <li>OTP email verification for account creation</li>
