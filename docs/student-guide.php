...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .glass-panel h3 { font-size: 1.05rem; font-weight: 600; margin-bottom: 8px; color: var(--primary); margin-top: 16px; }
        .glass-panel ul, .glass-panel ol { margin-left: 20px; color: var(--text-muted); line-height: 1.8; margin-bottom: 16px; }

        .step-number {
            display: inline-flex; align-items: center; justify-content: center;
            width: 28px; height: 28px; border-radius: 50%;
            background: rgba(0, 155, 217, 0.15); border: 1px solid rgba(0, 155, 217, 0.3);
            color: var(--primary); font-weight: 700; font-size: 0.85rem; margin-right: 8px; flex-shrink: 0;
        }
...
<body>
    ...
    <main class="page-content">
        ...
        <section class="glass-panel">
            ...
            <p>Visit the registration page and fill in your username, email, grade level, and password. You'll receive a 6-digit OTP code at your email to verify your account.</p>

            <h3><span class="step-number">2</span> Edit Your Profile or Add Friends</h3>
        ...
        <section class="glass-panel">
            <h2>Playing VocabWorld</h2>
            <p>VocabWorld is the main game where you explore a top-down RPG world while learning English vocabulary.</p>
            <ul>
                <li><strong>Movement:</strong> Use the on-screen joystick (mobile) or arrow keys (desktop) to move your character</li>
                <li><strong>Battles:</strong> Encounter vocabulary challenges as you explore the world</li>
                <li><strong>Progress:</strong> Complete levels to earn Shards and unlock new content</li>
                <li><strong>Minimap:</strong> Use the minimap in the corner to navigate the game world</li>
            </ul>
        </section>

        <section class="glass-panel">
            <h2>Learning with Lessons</h2>
            <p>Your creator may assign vocabulary lessons for you to study. Here's how to use them:</p>
            <ol>
                <li>Go to the Lessons section from your dashboard</li>
                <li>Study the vocabulary words and their definitions</li>
                <li>Complete the associated games to test your knowledge</li>
                <li>Your performance will be reflected in your Mastery Score (Learning Progress)</li>
            </ol>
        </section>
        ...
        <section class="glass-panel">
            ...
            <ul>
                <li><strong>Friends:</strong> Add other players as friends and view their profiles</li>
                <li><strong>Leaderboards:</strong> Compete with classmates on global rankings</li>
                <li><strong>Favorites:</strong> Save your favorite games for quick access</li>
                <li><strong>Profile:</strong> Customize your profile and upload a profile picture</li>
            </ul>
        </section>
        ...
        <section class="glass-panel">
            <h2>Need Help?</h2>
            <p>If you run into any issues or have questions, visit our <a href="support.php" style="color: var(--primary); text-decoration: none; font-weight: 500;">Support page</a> to contact the development team.</p>
        </section>
    </main>
