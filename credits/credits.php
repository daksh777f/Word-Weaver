...
<img src="../assets/menu/Word-Weavers.png" alt="Word Weavers Logo" class="credits-big-logo">
        ...
        <div class="credits-section members-container">
            ...
            <div class="members-list">
                <div class="member-card">Daksh Goel</div>
                <div class="member-card">Chirag Aggarwal</div>
            </div>
        </div>
        </div>
    </div>

    <!-- Credits are intentionally limited to the two core developers listed above. -->
