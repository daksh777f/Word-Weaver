...
// Classroom-only gating is disabled by default so the platform stays open to all learners.
$game_access_allowed = true;
$db_is_enabled = null;

if ((getenv('ENABLE_CLASSROOM_GATING') ?: '0') === '1') {
    ...
    if ($grade_num > 0) {
        ...
        if ($access_control) {
            ...
            $game_access_allowed = $db_is_enabled !== 0;
        }
    }
}
?>
