            ...
            <div class="user-profile-header">
                ...
                <div class="profile-info">
                    ...
                    <div class="badge-container">
                        <?php 
                        $is_jaderby = in_array(strtolower($viewed_user['username']), ['daksh goel', 'chirag aggarwal'], true);
        ...
        <div class="game-stats-modal-content" id="gameStatsContent">
            ...
            <div class="game-stats-modal-body">
                ...
                <div class="stats-sections">
                    ...
                    <div class="stats-category">
                        <div class="category-header">
                            <img src="../profile/assets/fc133.png" alt="Resources" style="width: 24px; height: 24px; margin-right: 8px;">
                            <h4>Resources</h4>
                        </div>
                    ...
                    <div class="stats-category">
                        <div class="category-header">
                            <img src="../profile/assets/fc112.png" alt="Performance" style="width: 24px; height: 24px; margin-right: 8px;">
                            <h4>Performance</h4>
                        </div>
                        <div class="stats-cards-grid">
