...
<head>
    ...
    <title>Vocabulary Bank - CodeDungeon</title>
                    ...
                    <div class="table-controls" style="margin-left: auto;">
                        <div class="filter-group">
                            <div class="grade-filter">
                                <label for="gradeFilterVocab">Audience:</label>
                    ...
                    <table class="vocab-table">
                        <thead>
                            <tr>
                                ...
                                <th class="sortable" data-sort="grade" data-order="asc">Audience</th>
                                ...
                                <?php foreach ($vocabulary_questions as $question): ?>
                                    <tr data-word="<?= strtolower(htmlspecialchars($question['word'])) ?>" 
                                        ...
                                        <td data-label="Audience">
                                            <span class="grade-badge"><?= htmlspecialchars($question['grade_level']) ?> Level</span>
                                        </td>
    ...
    <div class="modal-overlay" id="vocabModal">
        <div class="modal-content vocab-modal">
            ...
            <form id="vocabForm" onsubmit="saveVocab(event)">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="gradeLevel">Target Audience <span class="required">*</span></label>
