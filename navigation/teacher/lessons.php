...
<head>
    ...
    <title>Lessons - CodeDungeon</title>
                    ...
                    <div class="table-controls" style="margin-left: auto;">
                        <div id="filterForm">
                            <div class="grade-filter">
                                <label for="gradeFilter">Audience:</label>
                                <select id="gradeFilter" name="grade" onchange="filterLessons()">
                                    <option value="all" <?= $selected_grade === 'all' ? 'selected' : '' ?>>All Audiences</option>
                                    <option value="Beginner" <?= $selected_grade === 'Beginner' ? 'selected' : '' ?>>Beginner</option>
                                    <option value="Intermediate" <?= $selected_grade === 'Intermediate' ? 'selected' : '' ?>>Intermediate</option>
                                    <option value="Advanced" <?= $selected_grade === 'Advanced' ? 'selected' : '' ?>>Advanced</option>
                                    <option value="Expert" <?= $selected_grade === 'Expert' ? 'selected' : '' ?>>Expert</option>
                                </select>
                            </div>
                            <div class="grade-filter">
                                ...
                                <?php foreach ($lessons as $lesson): ?>
                                    <tr>
                                        ...
                                        <td data-label="Audience">
                                            <span class="grade-badge"><?= htmlspecialchars($lesson['grade_level']) ?> Level</span>
                                        </td>
